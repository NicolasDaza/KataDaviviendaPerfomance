# Gatling Project for npm - Exported NoCode Simulation

Welcome, this is your exported project. It is ready to be used on Gatling Enterprise as a JavaScript packaged simulation.
...
Configure your API Token as a `GATLING_ENTERPRISE_API_TOKEN` environment variable:

```console
export GATLING_ENTERPRISE_API_TOKEN=your-token-here
```

## Deploy your simulation using npm
...
Find more details about using Gatling with JavaScript in our [documentation](https://docs.gatling.io/reference/integrations/build-tools/js-cli/).
